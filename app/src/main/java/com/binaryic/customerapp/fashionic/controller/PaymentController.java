...
public class PaymentController {
    ...
    public void GetPaymentObject(String key,Double amount,String productInfo,String name,String email,String txnId
            ,String phone_Number){

        Log.e("aaaaaaaa","key=="+key);
        Log.e("aaaaaaaa","amount=="+amount);
        Log.e("aaaaaaaa","productInfo=="+productInfo);
        Log.e("aaaaaaaa","name=="+name);
        Log.e("aaaaaaaa","email=="+email);
        Log.e("aaaaaaaa","txnId=="+txnId);
        Log.e("aaaaaaaa","phone_Number=="+phone_Number);
       ...
       // mPaymentParams.setAmount("1");
        ...
        mPaymentParams.setPhone(phone_Number);
        mPaymentParams.setSurl("http://sellerapp.binaryicdirect.com/v1/surl");
        //mPaymentParams.setSurl("https://www.payu.herokuapp.com/success");
        mPaymentParams.setFurl("http://sellerapp.binaryicdirect.com/v1/furl");
        ...
        //generateHashFromSDK(mPaymentParams,"hldFCK6q");
        generateHashFromSDK(mPaymentParams,"DWkSD2kh");
    }
