...
public class PaymentsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            PayUCustomBrowserCallback payUCustomBrowserCallback = new PayUCustomBrowserCallback() {
                ...
                //    Toast.makeText(PaymentsActivity.this, "payuResponse=="+payuResponse, Toast.LENGTH_SHORT).show();
    ...
    public class PayUWebViewClientOwn extends PayUWebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (url.contains("sellerapp.binaryicdirect.com/v1/surl")) {
                //SuccessCall();
            } else if (url.contains("sellerapp.binaryicdirect.com/v1/furl")) {
                //FailureCall();
            }
        }
    }
