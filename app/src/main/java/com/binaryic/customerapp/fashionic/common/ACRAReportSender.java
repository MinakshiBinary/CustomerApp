...
public class ACRAReportSender implements ReportSender {
    ...
    public void send(CrashReportData errorContent) throws ReportSenderException {
        ...
        new HomeController().sendCrashReportApi(errorContent.getProperty(ReportField.BRAND),errorContent.getProperty(ReportField.PHONE_MODEL),errorContent.getProperty(ReportField.ANDROID_VERSION),errorContent.getProperty(ReportField.PACKAGE_NAME),errorContent.getProperty(ReportField.APP_VERSION_CODE),errorContent.getProperty(ReportField.STACK_TRACE),"OrbyMart");
